...
def main():
    ...
    def get_languages():
        source = simpledialog.askstring("Input", "Please enter source language (e.g., en, fr, es, hin):")
        dest = simpledialog.askstring("Input", "Please enter destination language (e.g., en, fr, es, hin):")
